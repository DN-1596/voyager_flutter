...
class SegmentChainer {
  ...
  late List<List<JTS.Coordinate>> regions;
  late Match first_match;
  late Match second_match;
  late Match? next_match;
  ...
  List<List<JTS.Coordinate>>? chain(SegmentList segments) {
    ...
    for (var seg in segments) {
      ...
      JTS.Coordinate pt1 = seg.start!;
      JTS.Coordinate pt2 = seg.end!;
